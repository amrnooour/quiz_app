...
class QuestionPage extends StatelessWidget {
  static const routeName = "statePage";
...
class QuestionCard extends StatelessWidget {
  ...
  const QuestionCard({required this.question}) : super();
...
class Option extends StatelessWidget {
  ...
  const Option({required this.text, required this.index, required this.press}) : super();
